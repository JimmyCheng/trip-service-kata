...
public class TripServiceTest {
    ...
    public void should_not_return_any_friends_when_users_are_not_friends() {
        User friend = aUser().friendWith(ANOTHER_USER).withTrips(TO_BRAZIL).build();
    ...
    public void should_retrun_friend_trips_when_users_are_friends() throws Exception {
        ...
        User friend = aUser().friendWith(ANOTHER_USER, REGISTERED_USER).withTrips(TO_BRAZIL, TO_LONDON).build();
